...
<html lang="es">
    <head>
        ...
        <title>Inventario - Huellitas Felices</title>
    ...
    <body>
        ...
        <aside class="sidebar">
            ...
            <nav class="nav-links">
                ...
                <a href="CitaServlet" class="nav-link">
        ...
        <main class="main-content">
            <div class="card">
              <div class="header-flex">
                ...
                <button type="button" class="btn btn-primary btn-create" onclick="window.location.href='${pageContext.request.contextPath}/ProductoServlet?vista=registro'">
