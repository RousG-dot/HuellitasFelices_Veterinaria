...
<html lang="es">
    <head>
        ...
        <title>Editar Cliente - Huellitas Felices</title>
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&display=swap" rel="stylesheet">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/editarCliente.css">
    ...
    <body>
        <aside class="sidebar">
            ...
            <nav class="nav-links">
                ...
                <a href="${pageContext.request.contextPath}/LogoutServlet" class="nav-link danger">
        ...
        <main class="main-content">
            <div class="form-card">
                <h1 class="header-title">Editar Cliente</h1>
                <p class="header-subtitle">Modifica los datos personales del dueño en el sistema</p>
                ...
                <form action="ClienteServlet" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="txtapellido" value="<%= request.getParameter("apellido") %>" required>
                    </div>
                    
                    <div class="form-group">
                        <label>DNI</label>
                        <input type="text" name="txtdni" value="<%= request.getParameter("dni") %>" maxlength="8" required>
                    </div>
                    
                    <div class="form-group">
                        <label>Teléfono</label>
                        <input type="tel" name="txttelefono" value="<%= request.getParameter("telefono") %>" required>
                    </div>

                    <div class="form-group">
                        <label>Correo Electrónico</label>
                        <input type="email" name="txtcorreo" value="<%= request.getParameter("correo") %>" required>
                    </div>
